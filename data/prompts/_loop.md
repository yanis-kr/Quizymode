...
- {folder}=data/seed-source/items/business
- {progress}=data/generated/seed-progress/business/_progress.md
- {state}=data/generated/seed-progress/business/_business_state.md
...
After adding files, run `python scripts/regenerate_business_progress.py` to update {progress}. The `data/generated/seed-progress/` folder is git-ignored and is the continuity source between prompt runs.
