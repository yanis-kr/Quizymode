...
- {progress}=generated/seed-progress/business/_progress.md
- {state}=generated/seed-progress/business/_business_state.md
...
After adding files, run `python scripts/regenerate_business_progress.py` to update {progress}. The `generated/seed-progress/` folder is git-ignored and is the continuity source between prompt runs.
