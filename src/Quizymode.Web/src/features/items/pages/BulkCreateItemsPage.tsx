...
- Field length limits: "question" max 1000 chars; "correctAnswer" and each "incorrectAnswers" item max 500 chars; "source" max 1000 chars (URL only); "explanation" max 4000 chars. Truncate if needed.
