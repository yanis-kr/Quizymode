    ...
    public sealed class Endpoint : IEndpoint
    {
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                foreach (JsonItemRequest jsonItem in request.Items)
                {
                    string questionText = $"{jsonItem.Question} {jsonItem.CorrectAnswer} {string.Join(" ", jsonItem.IncorrectAnswers)}";
                ...
                {
                    db.Items.AddRange(importedItems);
