...
- **AC 3.0.6** [Anyone] **Given** I am on the home page below the categories section, **when** I view the Featured Sets lane, **then** I see a horizontal carousel of featured keyword sets; each card links directly to a pre-filtered quiz URL; the set of cards is driven by the `featuredSetCards` array in `src/features/home/homePageData.ts`.
