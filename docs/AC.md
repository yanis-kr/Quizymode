...
- **AC 3.6.2a** [Anyone] **Given** I am in **Flashcards** mode for a **category/keywords** or **global** scope, **when** I view the current item, **then** the **question** is shown face-up on the card; **when** I click the card, **then** it flips to show the **correct answer** and **explanation** (if any); **when** I click again, **then** I can flip back to the question; **when** I go to the previous or next item, **then** the card resets to show the question face-up.
