...
#
# Usage: .\scripts\run-e2e-local-smoke.ps1
...
$runId    = "smoke-$(Get-Date -Format 'yyyy-MM-dd_HH-mm-ss')"
...
try {
    ...
    npx playwright test --project=smoke --output="$outputDir"
